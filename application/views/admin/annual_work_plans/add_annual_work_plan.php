    ...
    <div class="col-md-12">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart(ADMIN_DIR . "annual_work_plans/save_data", $add_form_attr);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?php
                        echo form_dropdown("sub_component_id", $sub_components, "", "class=\"form-control\" required style=\"\"");
                        ?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?php
                        echo form_dropdown("financial_year_id", $financial_years, "", "class=\"form-control\" required style=\"\"");
                        ?>
                    </div>
