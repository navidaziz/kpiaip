	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."districts/update_data/$district->district_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("district_id", $district->district_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("district_name", $district->district_name),
					...
					$options = array("Yes" => "Yes", "No" => "No");
                        foreach($options as $option_value => $options_name){
                            ...
                            $data = array(
                                ...
                                "class"       => "uniform"
                                );if($option_value == $district->division){
                                    $data["checked"] = TRUE;
                                }
					...
					$options = array("Yes" => "Yes", "No" => "No");
                        foreach($options as $option_value => $options_name){
                            ...
                            $data = array(
                                ...
                                "style"       => "","required"	  => "required",
                                "class"       => "uniform"
                                );if($option_value == $district->region){
                                    $data["checked"] = TRUE;
                                }
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("district_latitude", $district->district_latitude),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("district_logitude", $district->district_logitude),
