<form id="payment_notesheets" class="form-horizontal" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group row">
        <label for="puc_title" class="col-sm-4 col-form-label">Puc Title</label>
        <div class="col-sm-8">
            <input type="text" required id="puc_title" name="puc_title" value="<?php echo $input->puc_title; ?>" class="form-control">
        </div>
    </div>
    <div class="form-group row">
        <label for="puc_detail" class="col-sm-4 col-form-label">Puc Detail</label>
        <div class="col-sm-8">
            <input type="text" required id="puc_detail" name="puc_detail" value="<?php echo $input->puc_detail; ?>" class="form-control">
        </div>
    </div>
    <div class="form-group row">
