...
<body>
    ...
    <section id="page">
        ...
        <div id="main-content"
            <?php if ($this->router->fetch_class() == 'payment_notesheets' or $this->router->fetch_class() == 'reports'  or $this->router->fetch_class() == 'expenses' or $this->router->fetch_class() == 'annual_work_plans' or $this->router->fetch_class() == 'riders') { ?>
