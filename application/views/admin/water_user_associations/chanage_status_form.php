    ...
    <form id="data_form" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        ...
        <?php if ($status_form == 'Complete') { ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="date" name="completion_date" value="<?php echo $scheme->completion_date; ?>" id="completion_date" class="form-control" style="" required="required" title="Completion Date" placeholder="Completion Date">
                </div>
        ...
        <?php if ($status_form == 'Approval') { ?>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8">
                    <input type="date" name="approval_date" value="<?php echo $scheme->approval_date; ?>" id="approval_date" class="form-control" style="" required="required" title="Approval Date" placeholder="Approval Date">
                </div>
