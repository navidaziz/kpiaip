            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return '<a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR . "water_user_associations/view_water_user_association/"); ?>' +
                            row.water_user_association_id + '/' +
                            '"><i class="fa fa-eye"></i></a><span style="margin-left: 15px;"></span>' +
