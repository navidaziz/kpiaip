	...
	<div class="box border blue" id="messenger">
        ...
        <div class="box-body">
            ...
            <?php
                ...
                echo form_open_multipart(ADMIN_DIR."vendors/update_data/$vendors->vendor_id", $edit_form_attr);
            ?>
            <?php echo form_hidden("vendor_id", $vendors->vendor_id); ?>
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("Vendor_Type", $vendors->Vendor_Type),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_NTN", $vendors->TaxPayer_NTN),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_CNIC", $vendors->TaxPayer_CNIC),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_Name", $vendors->TaxPayer_Name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_City", $vendors->TaxPayer_City),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_Address", $vendors->TaxPayer_Address),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_Status", $vendors->TaxPayer_Status),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("TaxPayer_Business_Name", $vendors->TaxPayer_Business_Name),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("Focal_Person", $vendors->Focal_Person),
            ...
            <div class="form-group">
                ...
                <?php
                    ...
                    $text = array(
                        ...
                        "value"         =>  set_value("Contact_No", $vendors->Contact_No),
