                ...
                <div class="col-md-12">
                    ...
                    <div style="padding:5px; border:1px solid #54789B; border-radius:5px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" req uired id="bank_account_number" name="bank_account_number" value="<?php echo convertToExactNumber2($wua->bank_account_number); ?>" class="formControl">
                            </div>
                        </div>
                        <div class="form-group row">
