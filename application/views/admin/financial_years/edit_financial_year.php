    ...
    <div class="col-md-12">
        <div class="box border blue" id="messenger">
            ...
            <div class="box-body">
                ...
                echo form_open_multipart(ADMIN_DIR . "financial_years/update_data/$financial_year->financial_year_id", $edit_form_attr);
                ?>
                <?php echo form_hidden("financial_year_id", $financial_year->financial_year_id); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <?php
                        echo form_dropdown("project_id", $projects, $financial_year->project_id, "class=\"form-control\" required style=\"\"");
                        ?>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $date = array(
                            ...
                            "value"         =>  set_value("start_date", $financial_year->start_date),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $date = array(
                            ...
                            "value"         =>  set_value("end_date", $financial_year->end_date),
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        $text = array(
                            ...
                            "value"         =>  set_value("financial_year", $financial_year->financial_year),
