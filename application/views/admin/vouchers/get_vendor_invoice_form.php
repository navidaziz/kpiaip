<form id="vendors_taxes" class="form-horizontal" enctype="multipart/form-data" method="post">
    ...
    <div style="border: 1px solid gray; border-radius:5px; padding:5px; margin-bottom:10px">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-4">
                <label for="st_charged_per" class="col-form-label">ST Charged (Rs)</label>
                <input type="number" step="any" onkeyup="calculate_taxes()" required id="st_charged" name="st_charged" value="<?php echo $input->st_charged; ?>" class="form-control">
            </div>
    ...
    <div style="border: 1px solid gray; border-radius:5px; padding:5px">
        <strong>Taxes Deducation</strong>
        <hr />
        <div class="form-group row">
            <label for="whit_tax_per" class="col-sm-3 col-form-label">WHIT Rate (%)</label>
            <div class="col-sm-3">
                <input type="number" min="0" step="any" max="100" onkeyup="calculate_whit_tax()" required id="whit_tax_per" name="whit_tax_per" value="5.5" class="form-control">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="number" min="0" step="any" max="100" onkeyup="calculate_whst_tax()" required id="whst_tax_per" name="whst_tax_per" value="20.0" class="form-control">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="number" min="0" step="any" max="100" onkeyup="calculate_st_duty_tax()" required id="st_duty_tax_per" name="st_duty_tax_per" value="1" class="form-control">
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <input type="number" min="0" step="any" max="100" onkeyup="calculate_rdp_tax()" required id="rdp_tax_per" name="rdp_tax_per" value="0.7" class="form-control">
            </div>
...
<script>
    ...
    $('#vendors_taxes').submit(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url(ADMIN_DIR . "vouchers/add_vendor_invoice"); ?>', // URL to submit form data
            data: formData,
