...
<th><?php echo $this->lang->line('wua_name'); ?></th><th><?php echo $this->lang->line('Status'); ?></th><th><?php echo $this->lang->line('Action'); ?></th>
                        </tr>
						</thead>
						<tbody>
            ...
            <td>
                <?php echo $scheme->wua_name; ?>
                                ...
                                <td>
                                    <?php echo status($scheme->status,  $this->lang); ?>
                                    <?php
                                        ...
                                        if($scheme->status == 0){
                                            echo "<a href='".site_url(ADMIN_DIR."schemes/publish/".$scheme->scheme_id."/".$page)."'> &nbsp;".$this->lang->line('Publish')."</a>";
                                        }elseif($scheme->status == 1){
                                            echo "<a href='".site_url(ADMIN_DIR."schemes/draft/".$scheme->scheme_id."/".$page)."'> &nbsp;".$this->lang->line('Draft')."</a>";
                                        }
                                    ?>
                                </td>
                                <td>
                                <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR."schemes/view_scheme/".$scheme->scheme_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-eye"></i> </a>
                                <a class="llink llink-edit" href="<?php echo site_url(ADMIN_DIR."schemes/edit/".$scheme->scheme_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-pencil-square-o"></i></a>
                                <a class="llink llink-trash" href="<?php echo site_url(ADMIN_DIR."schemes/trash/".$scheme->scheme_id."/".$this->uri->segment(4)); ?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                         </tr>
                      <?php endforeach; ?>
						</tbody>
