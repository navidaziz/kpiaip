                        ...
                        <tbody>
                            <?php foreach ($component_categories as $component_category) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="llink llink-view" href="<?php echo site_url(ADMIN_DIR . "component_categories/view_component_category/" . $component_category->component_category_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-eye"></i> </a>
                                        <a class="llink llink-restore" href="<?php echo site_url(ADMIN_DIR . "component_categories/restore/" . $component_category->component_category_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-undo"></i></a>
                                        <a class="llink llink-delete" href="<?php echo site_url(ADMIN_DIR . "component_categories/delete/" . $component_category->component_category_id . "/" . $this->uri->segment(3)); ?>"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
