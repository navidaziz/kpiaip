                        ...
                        <table class="table table-bordered table-striped" style="color: black !important;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    ?>
                                    <th>A: WCs (Nos)</th>
                                    <td><?php echo $component_a->total; ?></td>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <th>B2: WST (Nos)</th>
                                    <td><?php echo $component_b2->total; ?></td>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <th>B3: Laser (Nos)</th>
                                    <td><?php echo $component_b3->total; ?></td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    ?>
                                    <th>Total</th>
                                    <th><?php echo $component->total; ?></th>
                        ...
                        <table class="table table-bordered table-striped" style="color: black !important;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th>A: WCs (Nos)</th>
                                    <td>
                                        <small>PC:</small> <?php echo $component_a_phy_completed->total; ?><br />
                                        <small>FC:</small> <?php echo $component_a_completed->total; ?><br />
                                        -----------<br />
                                        <small>
                                            T: <?php echo $component_a_phy_completed->total + $component_a_completed->total; ?>
                                        </small>

                                    </td>
                                    <td>

                                        BA-PC: <?php echo $component_a_phy_completed->balance; ?><br />
                                        PA-FC: <?php echo $component_a_completed->total_paid; ?><br />
                                        -----------<br />
                                        = <?php echo ($component_a_phy_completed->balance + $component_a_completed->total_paid); ?>

                                    </td>
                                    <td>
                                        <small>PC:</small> <?php echo $component_a_phy_completed->total_paid; ?><br />
                                        <small>FC:</small> <?php echo $component_a_completed->total_paid; ?><br />
                                        -----------<br />
                                        <small>
                                            T: <?php echo $component_a_phy_completed->total_paid + $component_a_completed->total_paid; ?>
                                        </small>

                                    </td>
                                    <td>
                                        <small>PC:</small> <?php echo $component_a_phy_completed->balance; ?><br />
                                        <small>FC:</small> <?php echo $component_a_completed->balance; ?><br />
                                        -----------<br />
                                        <small>
                                            T: <?php echo $component_a_phy_completed->balance + $component_a_completed->balance; ?>
                                        </small>
