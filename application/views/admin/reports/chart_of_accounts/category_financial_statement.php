                        ...
                        foreach ($components as $component) { ?>
                            ...
                            ?>
                                    ...
                                    if (@$sub_component->component_categories) {
                                        foreach ($sub_component->component_categories as $component_categories) {
                                    ?>
                                            <tr>
                                                <td></td>
                                                <td colspan="2" style="padding-left:50px;">
                                                    <strong><?php echo $component_categories->category; ?></strong>
                                                    <small> <?php echo $component_categories->category_detail; ?></small>
                                                </td>
                                                <td style="display: none;"></td>
