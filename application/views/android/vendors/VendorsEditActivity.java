...
public class VendorsEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_vendors);
		...
		RequestQueue request_queue = Volley.newRequestQueue(VendorsEditActivity.this);
		StringRequest request = new StringRequest(Request.Method.POST, SERVER_URL+"/mobile/vendors/view_vendors/"+id, new Response.Listener<String>() {
								@Override
            ...
            public void onClick(View v) {
              final String form_Vendor_Type = Vendor_Type.getText().toString();
				...
				RequestQueue request_queue = Volley.newRequestQueue(VendorsAddActivity.this); 
				 StringRequest request = new StringRequest(Request.Method.POST, url+"/mobile/vendors/save_data/"+form_vendor_id, new Response.Listener<String>() {
								@Override
								public void onResponse(String server_response) {
